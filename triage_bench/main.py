...
from triage_bench.benchmark_runner import create_client
# ───────────────────────────────────────────────────────────
...
def main():
    ...
    parser.add_argument("--model", 
                        ...
                        help="Model name. Examples: 'gpt-4o', 'deepseek-chat', 'llama3.1', 'qwen2.5', 'ollama+llama3.1'")
    ...
    # Client factory (supports OpenAI, DeepSeek, Ollama, and other providers)
